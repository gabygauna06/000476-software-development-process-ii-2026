# Procesos de Desarrollo de Software II

Repositorio académico correspondiente a la materia **Procesos de Desarrollo de Software II** de la carrera de Ingeniería en Informática.

Este repositorio se utiliza para organizar y conservar el material académico proporcionado y producido durante la cursada 2026.

[English version](README.md)

## Información de la Materia

- **Asignatura:** Procesos de Desarrollo de Software II
- **Código:** 000476
...
- **Tipo:** Obligatoria
- **Año académico del repositorio:** 2026
...
3. **Mejorando el Diseño con UML y Patrones**
4. **Patrones de Diseño**
5. **Metodologías Ágiles**

## Estructura del Repositorio

El repositorio se construye progresivamente a medida que aparece material real de la materia.
...
El repositorio mantiene las siguientes convenciones:

- los nombres de archivos y directorios se escriben en inglés
- los nombres utilizan `lowercase-kebab-case`
- los documentos oficiales conservan su contenido académico original
...
Este repositorio está destinado a la organización académica, estudio, documentación y trazabilidad del material utilizado durante Procesos de Desarrollo de Software II.
