...
Academic repository for the **Software Development Process II** course of the Computer Engineering degree program.

This repository is used to organize and preserve the academic material provided and produced throughout the 2026 course.

[Versión en español](README.es.md)

## Course Information

- **Course:** Software Development Process II
- **Course code:** 000476
...
3. **Improving Design with UML and Patterns**
4. **Design Patterns**
5. **Agile Methodologies**

## Repository Structure

The repository is built progressively as actual course material becomes available.
...
- directory and file names are written in English
- names use `lowercase-kebab-case`
- official documents preserve their original academic content
...
This repository is intended for academic organization, study, documentation, and traceability of the material used throughout Software Development Process II.
